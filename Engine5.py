"""
Engine.py — Engine #5 (Sequential Loop)
=========================================
Channel: TV ONE, TVRI
Jalankan bersama Engine.py s/d Engine5.py secara paralel
untuk memproses semua 11 channel dengan efisien.

Cara menjalankan (masing-masing di terminal terpisah):
    python Engine.py
    python Engine2.py
    python Engine3.py
    python Engine4.py
...
# =============================================================================
CHANNELS = [
    # ('tvone',         '/home/comvis/siputri/TVONESTREAMING'),
    # ('tvri',          'D:\\Medmon\\Raw-data\\TVRI'),
    ('tvriyogya',     'D:\\Medmon\\Raw-data\\TVRIYOGYASTREAMING'),
    ('tvrijatim',     'D:\\Medmon\\Raw-data\\TVRIJATIMSTREAMING'),
]
...
def process_channel(channel: str, channel_path: str) -> None:
    ...
    try:
        ...
        send_telegram_alert(engine_name="Engine5", channel_name=channel, error_message=str(e), stacktrace=traceback.format_exc())
...
def delete_routine() -> None:
    ...
    try:
        ...
        print(traceback.format_exc())
        send_telegram_alert(engine_name="Engine5", channel_name="DELETE_ROUTINE", error_message=str(e), stacktrace=traceback.format_exc())
...
if __name__ == '__main__':
    print("=" * 60)
    print("  Engine #5 — Sequential Channel Processor")
