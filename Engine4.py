"""
Engine.py — Engine #4 (Sequential Loop)
=========================================
Channel: NUSANTARA TV, MNC TV
...
# =============================================================================
CHANNELS = [
    ('nusantaratv',   '/home/comvis/remote1/NUSANTARATVSTREAMING'),
    ('mnctv',         '/home/comvis/remote2/MNCSTREAMING'),
]
...
def process_channel(channel: str, channel_path: str) -> None:
    ...
    try:
        ...
        send_telegram_alert(engine_name="Engine4", channel_name=channel, error_message=str(e), stacktrace=traceback.format_exc())
...
def delete_routine() -> None:
    ...
    try:
        ...
        print(traceback.format_exc())
        send_telegram_alert(engine_name="Engine4", channel_name="DELETE_ROUTINE", error_message=str(e), stacktrace=traceback.format_exc())
...
if __name__ == '__main__':
    print("=" * 60)
    print("  Engine #4 — Sequential Channel Processor")
