"""
Engine.py — Engine #3 (Sequential Loop)
=========================================
Channel: IDX CHANNEL, INEWS TV
...
# =============================================================================
CHANNELS = [
    ('idxchannel',    '/home/comvis/siputri/IDXSTREAMING'),
    ('inewstv',       '/home/comvis/remote1/INEWSSTREAMING'),
]
...
def process_channel(channel: str, channel_path: str) -> None:
    ...
    try:
        ...
        send_telegram_alert(engine_name="Engine3", channel_name=channel, error_message=str(e), stacktrace=traceback.format_exc())
...
def delete_routine() -> None:
    ...
    try:
        ...
        print(traceback.format_exc())
        send_telegram_alert(engine_name="Engine3", channel_name="DELETE_ROUTINE", error_message=str(e), stacktrace=traceback.format_exc())
...
if __name__ == '__main__':
    print("=" * 60)
    print("  Engine #3 — Sequential Channel Processor")
