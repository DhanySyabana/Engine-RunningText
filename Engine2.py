"""
Engine.py — Engine #2 (Sequential Loop)
=========================================
Channel: TRANS7, BERITA SATU
...
# =================================================================z============
CHANNELS = [
    ('trans7',        '/home/comvis/remote1/TRANS7STREAMING'),
    ('beritasatu',    '/home/comvis/siputri/BERITASATUSTREAMING'),
]
...
def process_channel(channel: str, channel_path: str) -> None:
    ...
    try:
        ...
        send_telegram_alert(engine_name="Engine2", channel_name=channel, error_message=str(e), stacktrace=traceback.format_exc())
...
def delete_routine() -> None:
    ...
    try:
        ...
        print(traceback.format_exc())
        send_telegram_alert(engine_name="Engine2", channel_name="DELETE_ROUTINE", error_message=str(e), stacktrace=traceback.format_exc())
...
if __name__ == '__main__':
    print("=" * 60)
    print("  Engine #2 — Sequential Channel Processor")
